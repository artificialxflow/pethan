        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
              About <span className="text-persian-500">MadeByPersians</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-8">
              <div className="persian-text bg-white rounded-lg p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg p-6 shadow-lg hover-lift">
                ...
                <div className="bg-white rounded-lg p-6 shadow-lg hover-lift">
                  <Heart className="w-12 h-12 text-persian-500 mb-4" />
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-primary-500 to-persian-500 rounded-lg p-8 text-white">
                <img 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-persian-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Globe className="w-8 h-8 text-persian-500" />
              </div>
